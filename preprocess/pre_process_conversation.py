...
def get_interval_sum_and_var(daily_data):
    ...
    return np.sum(daily_interval),np.var(daily_interval),np.mean(daily_interval),len(daily_data)
...
if __name__ == '__main__':
    ...
    name = ['uid','conversation_sum','conversation_var','conversation_mean','conversation_day_num']
