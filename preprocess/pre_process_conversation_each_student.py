...
def main(file_dir):
    ...
    for i in all_filename:
        ...
        name = ['year','mon','day','conversation_time']
        ...
        #print(paths)
        if 'conversation' not in file_in_paths :
            os.mkdir('data20191117\\conversation\\')
        student.to_csv('data20191117\\conversation\\conversation_'+ student_uid + '.csv', encoding='gbk')
        print(student_uid)
    print('done')
...
def show_plt(uid,student):
    ...
    plt.savefig('data20191117\\conversation\\conversation_' + uid +".png")

if __name__ == '__main__':
    main('..\\input\\sensor\\conversation\\')